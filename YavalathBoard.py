...
from UI.BoardUI import BoardGraphics
...
class Board(QWidget):
    ...
    def on_ai_move_ready(self, move):
        ...
        self._send_message(f"Player {self.current_player} placed piece in {move[0]},{move[1]}")
        self.moveMade.emit()
    ...
    def _emit_game_result(self):
        ...
        if winner == 1:
            ...
            self._send_message("DEBUG: NO WIN/DRAW CONDITION")
